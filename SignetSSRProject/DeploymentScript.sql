...
AS Source (AttendanceID,EmployeeID,Date,Attendence,HourseMissed,Reason,Excused) 
ON Target.AttendanceID = Source.AttendanceID 
WHEN NOT MATCHED BY TARGET THEN 
INSERT (EmployeeID,Date,Attendence,HoursMissed,Reason,Excused)
VALUES (EmployeeID,Date,Attendence,HoursMissed,Reason,Excused);
